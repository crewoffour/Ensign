...
| Maritime frame rules pending (Session 4) | milsymbol renders sea own track (set 30, entity 150000) unframed, and forces the pending dash on fused tracks (30/160000, 35/140000, 35/150000). Ensign does not model these yet; validate against real NAIS/SAIS-derived SIDCs in Session 4. |
